...
> "Without design governance, we were shipping incredible features but building visual chaos."
> — CTO, MindStudio
...
<Image label="Figma before: chaos and fragmentation" caption="Initial state of design in Figma" alt="Figma chaos" />
